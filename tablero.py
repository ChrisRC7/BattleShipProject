...
class Tablero: 
    ...
    def __init__(self, BarcosA, BarcosB, BarcosC, ColocadosA, ColocadosB, ColodadosC, Nombre, Aciertos, Fallos, matrizJ, matrizE, RestantesA, RestantesE, Tiempo):
        pygame.init()
        ...
        def Guardar_Partida():
            ...
            archivo.write(str(self.BarcosA) + '/' + str(self.BarcosB) + '/' + str(self.BarcosC) + '/' + Nombre + '/' + str(self.Aciertos) + '/' + str(self.Fallos) + '/' + str(matrizJ) + '/' + str(matrizE) + '/' + str(self.RestantesA) + '/' + str(self.RestantesE))
            archivo.close
        ...
        def Ataque():
            while self.Turno:
                x=random.randint(0,9)
                y=random.randint(0,9)
                if self.matrizJ[y][x]!=4:
                    columna= x+10
                    fila= y
                    if self.matrizJ[y][x]==3:
                        self.matrizJ[y][x]= 4
                        time.sleep(1)
                        Fail()
                        print('La ia fallo')
